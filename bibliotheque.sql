...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 21 oct. 2022 à 18:47
...
(4, 'Quelle humanité face aux changements à venir?', 'Action collective', 'Philipe PascotJuan Branco, Vincent Mignerot', '2019-09-24', '18:00:00', 'Forts de ces grands succès, nous proposerons une grande soirée à la rentrée dont le thème sera: \"Quelle humanité face aux changements à venir ?\". Nous aimerions y faire interagir trois profils : un sur les mouvements sociaux, un autre sur la critique des ‘’élites’’ et un dernier sur la collapsologie. N’hésitez pas à nous souffler le nom de personnes qui pourraient correspondre à l’un des trois profils cités. Le but sera de poser les scénarios qui s\'offrent à nous, identifier les utopies souhaitables et avancer des stratégies pour y parvenir. Nous réunirons encore les acteurs locaux du changement (associations, collectifs, librairie coopérative).', '24sept.webp'),
(5, 'titre', 'Thème', 'invité', '2022-10-15', '22:57:00', 'Dérouler de la soiré', 'Titre.webp');
...
INSERT INTO `presentation` (`id`, `titre`, `image`, `description`, `contact`) VALUES
(1, 'Le nouveau Monde Montpellier', 'LOGO_LE_NOUVEAU_MONDE.png', 'Créer à la suite de \"Nuit debout\" mouvement citoyen de 2018.\r\n\r\nNotre mouvement vise 3 objectifs :.\r\n\r\n- Faire connaître les alternatives concrètes et locales.\r\n\r\n- Rendre l\'espace public et la parole politique au citoyen.\r\n\r\n- Créer du lien pour rassembler au-delà des clivages.\r\n\r\nComment ?.\r\n\r\nEn proposant des espaces et actions citoyennes, positives et originales : Apéros citoyens, ateliers de rencontre, semaine sans smartphone, collage de citations inspirantes, animation de ciné/débat, stand dans les festivals', 'nouveaumondemontpellier@hotmail.com');
...
INSERT INTO `user` (`id`, `pseudo`, `nom`, `prenom`, `mail`, `password`, `image`, `role`) VALUES
(1, 'olikoen', 'koenig', 'olivier', 'olikoen@yahoo.fr', '$2y$10$e4uHQJfWHEoLMDpCDGzAieDqg0DExuZ1t46Mi3nZ0YbNCv8hZHFyK', 'olivier.jpg\r\n', '1'),
(5, 'amour', 'Declosmenil', 'faustine', 'faustine@gmail.com', '$2y$10$3SH1UsmlfcDi435LqxaBges8T.1iA.swd6NNVD4glyrlmK3KC8HES', 'Faustine.webp', '3'),
(8, 'manon', 'Asseli', 'Manon', 'manon@gmail.com', '$2y$10$9YjOMvXAxRX3HmyzZh4xBuC3pmIWfidW8N.i2UDco00.uBCJnDayG', 'Manon.jpg', '2'),
(18, 'franckito', 'bernard', 'franck', 'franck@gmail.com', '$2y$10$59KTlxWwHU./HZB1q9MqLufc4UpfQclVCEB.eIsN3rpbt4kXwt0U6', 'Franck.png', '3');
...
--
-- Index pour la table `belletterie`
--
ALTER TABLE `belletterie`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT pour la table `belletterie`
--
ALTER TABLE `belletterie`
